(function(w, d) {
                ...
                if (n === "items" && items) {
                    ...
                    if (props[n]) {
                        ...
                        if (nm === "irchannel") {
                            ...
                            tagSrc += "&" + nm + "=" + encodeURIComponent(props[n])
                        }
                    }
                }
            }
    ...
    Event.prototype = {
        ...
        identify: function(props, options) {
            ...
            try {
                ...
                var undefSrcValue, camp = setMatchedConfig(getCampaignConfig(props.campaignId)),
                    nsess, matchingId, nodeSrc, isChannel, willFireIdentify;
                if (!camp) {
            ...
            var runGenerateClickId = function() {
                ...
                var jsGenerate = function() {
                    var istest = options.test,
                        ...
                        prev = 0,
                        off, letters = "abcdefghijklmnopqrsuvwxyz",
    ...
    var irEvent = new ImpactRadiusEvent("A3744970-50d8-4ec9-b089-2ac0e36788551", "U11", [{
        id: "17612",
        td: "prestashop.pxf.io",
        ad: "1493184",
        iw: null,
        ti: ["33806", "33807"],
        d: "(?:(?:.*?\\.prestashop\\.com)|(?:^prestashop\\.com))",
        gp: "irgwc",
        gc: "irclickid",
        csc: {
            domReady: 1,
